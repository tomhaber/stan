...
\\
\spc\spc{\small Allen Riddell, \  Marco Inacio, \ Jeff Arnold, \ }
\\
\spc\spc{\small Mitzi Morris \ }
\vfill
\vfill
\mbox{ } 
\hfill
...
\\
\spc{\footnotesize Microsoft Research NYC 2014}
\hfill 
{\footnotesize \tt mc-stan.org}

\mypart{Current:}{Stan 2.4}
...
\item codes log posterior (or penalized likelihood)
\end{itemize}
\item Stan \myemph{inference}
\vspace*{-4pt}
\begin{itemize}\small
\item Sampling for full Bayesian inference
\item Optimization + curvature for maximum likelihood estimates
\end{itemize}
\end{itemize}
...
\mypart{Appendix I}{Under the Hood}
...
\mypart{Appendix II}{Bayesian Data Analysis}
