...
\mypart{{\LARGE The Present:} \\ \spc\spc{\Huge Stan 2.4}}
...
\item calculates gradients, Hessians, etc., using auto-diff
\end{itemize}
\item Stan \myemph{inference}
\vspace*{-4pt}
\begin{itemize}\small
\item MCMC for full Bayesian inference (+ posterior analysis)
\item MLE for point estimates (+ Hessian-based error estimates)
\end{itemize}
\end{itemize}
